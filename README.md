...
Array structure for building charts (Aldaflux\ChartjsBundle\Model\ChartBuiderData).
Sample:
```
...
Type of chart: 
$type => TypeCharjs::CHARJS_BAR (use Aldaflux\ChartjsBundle\Utils\TypeCharjs;)
